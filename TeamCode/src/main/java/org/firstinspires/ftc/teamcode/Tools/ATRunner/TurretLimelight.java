...
//        telemetry.setMsTransmissionInterval(11);
    ...
    public double getDegree(){return turretMotor.getCurrentPosition() * degreesPerTick;}
//    public void update2(){
...
//            }
//
//            limit = !((Math.abs(turretMotor.getCurrentPosition()) * degreesPerTick) >= maxDegrees);
//            switch (state) {
//                case FOUND:
//
...
//            telemetry.addData("isHitting", !magnet.getState());
//            telemetry.addData("Degree", turretMotor.getCurrentPosition() * degreesPerTick);
    ...
    public void update(){
        if(-0.05 > gamepad.left_stick_x || gamepad.left_stick_x > 0.05){
            ...
            if (!locked) {
                ...
                limit = ((Math.abs(turretMotor.getCurrentPosition()) * degreesPerTick) >= maxDegrees) &&
                        ((Math.abs(turretMotor.getCurrentPosition()) / turretMotor.getCurrentPosition()) == direction);
...
//                    }
                    ...
                    case SWITCH:
                        ...
                        turretMotor.setPower(searchPower * direction);
                        break;
                ...
                telemetry.addData("Power", searchPower * direction);
                telemetry.addData("isHitting", limit);
                telemetry.addData("Degree", turretMotor.getCurrentPosition() * degreesPerTick);
                telemetry.addData("isValid", result.isValid());
                telemetry.addData("correct", correct);
                telemetry.addData("runtime", runtime.seconds());
